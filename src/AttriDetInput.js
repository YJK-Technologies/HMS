                ...
                <div class="row">
                    ...
                    <div class="exp-form-floating">
                      ...
                      {error && !attributeheader_code && (
                        <div className="text-danger">
                          Attribute Header Code should not be blank
                        </div>
                      )}
                    </div>
                  </div>
                  ...
                  <div className="col-md-3 form-group">
                    <div class="exp-form-floating">
                      ...
                      />{" "}
                      {error && !attributedetails_code && (
                        <div className="text-danger">
                          Attribute Sub Code should not be blank
                        </div>
                      )}
                    </div>
                  </div>
                  <div className="col-md-3 form-group">
                    <div class="exp-form-floating">
                      ...
                      />
                      {error && !attributedetails_name && (
                        <div className="text-danger">
                          Attribute Detail Name should not be blank
                        </div>
                      )}
                    </div>
                  </div>
