  ...
  return (
    <>
      <div className="invoice-container" ref={componentRef}>
        ...
        <h1 className="invoice-title">Inventory Receipt</h1>
        <div className="invoice-info">
          <div className="bill-to">
            <p>Receipt Id : {headerData[0].ReceiptID}</p>
            <p>Receipt Type : {headerData[0].Receipt_Type}</p>
            <p>Transaction Date : {new Date(headerData[0].DateReceived).toLocaleDateString()}</p>
          </div>
        </div>
