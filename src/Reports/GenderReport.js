...
const GenderReport = () => {
    ...
    const GenderReportPermission = permissions
        .filter(permission => permission.screen_type === 'GenderReport')
    ...
    const handleSearch = async () => {
        setLoading(true);
        try {
            const response = await fetch(`${config.apiBaseUrl}/GetGenderReport`, {
                method: "POST",
                headers: {
                    "Content-Type": "application/json"
                },
                body: JSON.stringify({
                    Gender: gender, StartDate: FromDate, EndDate: ToDate, company_code: sessionStorage.getItem("selectedCompanyCode")
                })
            });
            if (response.ok) {
    ...
    return (
        <div className="container-fluid Topnav-screen">
            ...
            <div className="d-flex p-3 bg-body-tertiary rounded-2 justify-content-between align-items-center mb-2 shadow-sm">
                <h2 className="mb-0 purbut fs-3">Gender Report</h2>
                <div className="d-sm-flex purbut">
                    <printbutton className="purbut" onClick={handleExportToExcel}>
                        <i className="bi bi-file-earmark-excel-fill"></i>
                    </printbutton>
                    {["view", "all permission"].some((permission) => GenderReportPermission.includes(permission)) && (
                        ...
                        <div class="dropdown mt-1" >
                            ...
                            <ul class="dropdown-menu menu">
                                ...
                                <li class="iconbutton  d-flex justify-content-center">
                                    {['all permission', 'view'].some(permission => GenderReportPermission.includes(permission)) && (
            ...
            <div className="card p-3 mb-2 bg-body-tertiary shadow-sm">
                <div className="row g-3">
                    ...
                    <div className="col-md-2">
                        <label className="form-label fw-semibold d-flex justify-content-start">Gender</label>
                        <Select
                            className=""
                            type="text"
