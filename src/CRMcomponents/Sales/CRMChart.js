      ...
      <div className="row g-4">
        ...
        <div className="col-md-6">
          <div className="card p-3 shadow-sm">
            <div className="d-flex justify-content-between align-items-center mb-2">
              ...
              <Select className="col-md-3 col-12" placeholder="Select Period" />
              <Select
        ...
        <div className="col-md-6">
          <div className="card p-3 shadow-sm">
            ...
            {renderChart(stageChartType, opportunityStages, "stage", "count")}
          </div>
        </div>
        ...
        <div className="col-md-6">
          <div className="card p-3 shadow-sm">
            <div className="d-flex justify-content-between align-items-center mb-2">
              ...
              <Select
                options={chartOptions}
                defaultValue={chartOptions[2]}
                onChange={(e) => setTrendChartType(e.value)}
                className="col-md-3"
              />
            </div>
            {renderChart(trendChartType, monthlyRevenue, "month", "revenue")}
          </div>
        </div>
      </div>
    </div>
